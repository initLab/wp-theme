...
?>	
	<div id="tribe-events-content" class="grid" data-title="<?php wp_title(); ?>">
		...
		<?php if( function_exists( 'tribe_get_ical_link' ) ): ?><a title="<?php esc_attr_e('iCal Import', 'tribe-events-calendar'); ?>" class="ical" href="<?php echo tribe_get_ical_link(); ?>"><?php _e('iCal Import', 'tribe-events-calendar'); ?></a><?php endif; ?>,
		<a href="/events/rss" class="rss">RSS</a>
